...
export default {
    ...
    captchaStatus: "Captcha status: {status}",
    eventMessagesStatus: "Event messages status: {status}",
    captchaRegenerate: "Generate new code",
    captchaCaption: "Type the code you see above to confirm you are not a robot.",
    captchaConfirmationMessage: "Captcha confirmed successfully! You can now send messages in <b>{groupname}</b>.",
    captchaAlreadyChecked: "You have already confirmed the captcha.",
    ...
    adaShieldMessage2: "<a href=\"tg://user?id={userid}\">{username}</a> marked as harmful.\nReason: AdaShield banned.",
    casMessage: "<a href=\"tg://user?id={userid}\">{username}</a> banned.\nReason: <a href=\"https://cas.chat/query?u={userid}\">CAS banned</a>.",
    casMessage2: "<a href=\"tg://user?id={userid}\">{username}</a> marked as harmful.\nReason: <a href=\"https://cas.chat/query?u={userid}\">CAS banned</a>.",
    ...
    userApproved: "User <a href=\"tg://user?id={userid}\">{username}</a> approved.",
    ...
    warningSigleMessage: "⚠️ <a href=\"tg://user?id={userid}\">{username}</a> has {warnings} warnings.\n\nReason:\n",
    warningPluralMessage: "⚠️ <a href=\"tg://user?id={userid}\">{username}</a> has {warnings} warnings.\n\nReasons:\n",
    warningBanMessage: "❌ <a href=\"tg://user?id={userid}\">{username}</a> has {warnings} warnings and has been banned.\n\nReasons:\n",
    ...
    warnBlockedTerm: "Sending of blocked term.",
    privacyPolicy: (() => [
