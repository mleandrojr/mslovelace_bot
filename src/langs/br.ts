...
export default {
    ...
    eventMessagesStatus: "Status das mensagens de eventos: {status}",
    captchaRegenerate: "Pressione aqui para gerar um novo código",
    captchaCaption: "Digite o código que você vê acima para confirmar que você não é um robô.",
    captchaConfirmationMessage: "Confirmação enviada com sucesso! Você já pode enviar mensagens no grupo <b>{groupname}</b>.",
    captchaAlreadyChecked: "Você já confirmou que não é um robô.",
    warnNameChanging: "<a href=\"tg://user?id={userid}\">{oldname}</a> mudou seu nome para <a href=\"tg://user?id={userid}\">{newname}</a>",
    unauthorizedCommand: "<a href=\"tg://user?id={userid}\">{username}</a>, você não tem autorização para enviar este comando aqui.\nEste incidente será reportado.",
    unauthorizedCommandReport: "A conta <a href=\"tg://user?id={userid}\">{username}</a> está tentando enviar um comando não autorizado em <a href=\"https://t.me/{chaturl}\">{chatname}</a>:\n<pre>{content}</pre>",
    ...
    bannedMessage: "Conta <a href=\"tg://user?id={userid}\">{username}</a> banida.\nMotivo: {reason}",
    ...
    adaShieldMessage: "Conta <a href=\"tg://user?id={userid}\">{username}</a> banida.\nMotivo: AdaShield.",
    adaShieldMessage2: "Conta <a href=\"tg://user?id={userid}\">{username}</a> marcada como nociva.\nMotivo: AdaShield.",
    casMessage: "Conta <a href=\"tg://user?id={userid}\">{username}</a> banida.\nMotivo: <a href=\"https://cas.chat/query?u={userid}\">CAS</a>.",
    casMessage2: "Conta <a href=\"tg://user?id={userid}\">{username}</a> marcada como nociva.\nMotivo: <a href=\"https://cas.chat/query?u={userid}\">CAS</a>.",
    ...
    warningSigleMessage: "⚠️ <a href=\"tg://user?id={userid}\">{username}</a> tem {warnings} advertências.\n\nMotivo:\n",
    warningPluralMessage: "⚠️ <a href=\"tg://user?id={userid}\">{username}</a> tem {warnings} advertências.\n\nMotivos:\n",
    warningBanMessage: "❌ <a href=\"tg://user?id={userid}\">{username}</a> levou ban por ter {warnings} advertências.\n\nMotivos:\n",
